...
class CardDataLogger(LoggerMixin):
    ...
    def __init__(self):
        ...
        self.csv_file = self.output_dir / f"card_scans_{datetime.now().strftime('%Y%m%d')}.csv"
        self.csv_columns = [
            "timestamp_iso",
            "scan_id",
            "image_filename",
        ...
        self.logger.info("Card data logger initialized", 
    ...
    def log_card_scan(self, 
        ...
        try:
            ...
            self.logger.info("Card scan logged successfully",
                           scan_id=scan_id,
    ...
    def _save_detailed_log(self, scan_id: str, card_info: CardInfo, csv_row: Dict[str, Any]):
        ...
        try:
            ...
            self.logger.error("Failed to save detailed log", scan_id=scan_id, error=str(e))
    ...
    def get_scan_summary(self) -> Dict[str, Any]:
        ...
        try:
            ...
            # Average confidence
            confidences = [float(s["ocr_confidence"]) for s in scans if s["ocr_confidence"]]
