...
class TestCSVWriter:
    ...
    def test_build_row_handles_missing_data(self, writer):
        ...
        pokemon_card = {"id": "test-001", "name": "Test Card"}
    ...
    def test_build_row_handles_nested_none_values(self, writer):
        ...
        pokemon_card = {"id": "test-002", "name": "Test Card 2", "set": None}
    ...
    def test_build_row_price_sources_serialization_edge_cases(self, writer):
        ...
        row_complex = writer.build_row(
            pokemon_card, price_data_complex, source_image_path
        )
