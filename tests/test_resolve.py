...
class TestPokemonTCGResolver:
    ...
    def sample_card_info(self):
        ...
        return CardInfo(
            name="Charizard", collector_number={"num": 4, "den": 102}, confidence=85.0
        )
    ...
    async def test_request_with_backoff_success(self, resolver):
        ...
        with (
            patch.object(resolver, "_ensure_session"),
    ...
    def test_find_best_match_priority_ranking(
        self, resolver, sample_card_info, sample_cards
    ):
    ...
    def test_find_best_match_low_confidence(self, resolver):
        ...
        card_info = CardInfo(
            name="CompletelyDifferent", collector_number={"num": 999, "den": 999}
        )
    ...
    def test_parse_card_data_valid(self, resolver):
        ...
        card_data = {
            ...
            "name": "Charizard",
            "number": "4",
            "set": {"name": "Base Set", "id": "base1", "releaseDate": "1999-01-09"},
            "rarity": "Holo Rare",
            "images": {"small": "url1", "large": "url2"},
    ...
    async def test_resolve_card_no_match(self, resolver):
        ...
        card_info = CardInfo(
            name="NonexistentCard", collector_number={"num": 999, "den": 999}
        )
