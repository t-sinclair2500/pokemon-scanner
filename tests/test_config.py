...
class TestSettings:
    ...
    def test_settings_case_insensitive(self):
        ...
        with patch.dict(
            os.environ, {"log_level": "WARNING", "cache_db_path": "test/path.db"}
        ):
            settings = Settings()
    ...
    def test_settings_validation(self):
        ...
        with patch.dict(
            os.environ,
            {"CACHE_EXPIRE_HOURS": "invalid", "CAMERA_INDEX": "not_a_number"},
        ):
...
TESSERACT_PATH=/custom/tesseract
    ...
    def test_configuration_priority_order(self):
        ...
        with patch.dict(
            os.environ, {"LOG_LEVEL": "ERROR", "CACHE_DB_PATH": "env_priority.db"}
        ):
            settings = Settings()
...
class TestEdgeCases:
    ...
    def test_empty_environment_variables(self):
        ...
        with patch.dict(
            os.environ,
            {"LOG_LEVEL": "", "CACHE_DB_PATH": "", "POKEMON_TCG_API_KEY": ""},
        ):
            settings = Settings()
