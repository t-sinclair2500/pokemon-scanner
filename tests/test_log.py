...
from src.utils.log import LoggerMixin, configure_logging, get_logger
...
class TestConfigureLogging:
    ...
    def test_configure_logging_idempotent(self):
        ...
        assert isinstance(first_config["logger_factory"], type(
            second_config["logger_factory"]
        ))
...
class TestLoggerMixin:
    ...
    def test_log_success_logs_completion_with_duration(self):
        ...
        context = {"event": "test_operation", "start_time": start_time, "user_id": 123}
    ...
    def test_log_success_without_start_time(self):
        ...
        context = {"event": "test_operation", "user_id": 123}
