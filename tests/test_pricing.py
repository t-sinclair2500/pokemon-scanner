...
class TestPokemonTCGPricer:
    ...
    def test_extract_prices_no_pricing(self, pricer):
        ...
        card = PokemonCard(
            id="test-3", name="Test", number="3", set_name="Test",
            set_id="test", rarity="Common", images={}
        )
    ...
    def test_extract_prices_partial_tcgplayer(self, pricer):
        ...
        card = PokemonCard(
            id="test-4", name="Test", number="4", set_name="Test",
            set_id="test", rarity="Common", images={},
            tcgplayer={
                "prices": {
                    "normal": {"market": 25.00}
    ...
    def test_extract_prices_partial_cardmarket(self, pricer):
        ...
        card = PokemonCard(
            id="test-5", name="Test", number="5", set_name="Test",
            set_id="test", rarity="Common", images={},
            cardmarket={
                "prices": {
                    "trendPrice": 30.00
    ...
    def test_extract_prices_malformed_data(self, pricer):
        ...
        card = PokemonCard(
            id="test-6", name="Test", number="6", set_name="Test",
            set_id="test", rarity="Common", images={},
            tcgplayer={
                "prices": {
                    "normal": {"market": None},
    ...
    def test_extract_prices_empty_prices_dict(self, pricer):
        ...
        card = PokemonCard(
            id="test-7", name="Test", number="7", set_name="Test",
            set_id="test", rarity="Common", images={},
            tcgplayer={"prices": {}},
            cardmarket={"prices": {}}
        )
    ...
    def test_extract_prices_missing_prices_key(self, pricer):
        ...
        card = PokemonCard(
            id="test-8", name="Test", number="8", set_name="Test",
            set_id="test", rarity="Common", images={},
    ...
    def test_extract_prices_numeric_strings(self, pricer):
        ...
        card = PokemonCard(
            id="test-9", name="Test", number="9", set_name="Test",
            set_id="test", rarity="Common", images={},
            tcgplayer={
                "prices": {
                    "normal": {"market": 42.50}
